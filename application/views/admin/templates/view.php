    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/templates/create" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="text-black font-w500">Upload Image (1000×500px)</label>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">Upload</span>
                                    </div>
                                    <div class="custom-file">
                                        <input name="image" type="file" class="custom-file-input" accept=".jpg,.png,.jpeg,.webp,.avif" required>
                                        <label class="custom-file-label selected">Choose File</label>
                                    </div>
                                </div>
                                <div class="form-group col-12">
                                    <label>Alt Name*</label>
                                    <input name="alt_name" type="text" class="form-control" placeholder="Image Alt Name" value="image">
                                </div>
                                <div class="form-group col-12">
                                    <label>Title*</label>
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <input name="templates_url" type="text" class="form-control" placeholder="Templates Url">
                                </div>
                                <div class="form-group col-12">
                                    <label>Seo Url*</label>
                                    <input name="seo_url" type="text" class="form-control" placeholder="Seo Url">
                                </div>
                                <div class="form-group col-12">
                                    <label>Meta Title*</label>
                                    <input name="meta_title" type="text" class="form-control" placeholder="Meta Title" value="nan">
                                </div>
                                <div class="form-group col-12">
                                    <label>Meta Description*</label>
                                    <input name="meta_description" type="text" class="form-control" placeholder="Meta Description" value="nan">
                                </div>
                                <div class="form-group col-12">
                                    <label>Meta Keyword*</label>
                                    <input name="meta_keyword" type="text" class="form-control" placeholder="Meta Keyword" value="nan">
                                </div>
                            </div>
                            <div class="form-group">
        ...
        <div class="modal fade" id="deleteOrderModalside">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/templates/delete" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input name="id" type="text" value="1" id="deleteRowModalId" hidden>
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ New Template</a>
            </div>
                                ...
                                <table id="example3" class="display min-w850 dataTable no-footer" role="grid" aria-describedby="example3_info">
                                    <thead>
                                        <tr role="row">
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="example3" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 182.703px;">Template Url</th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <img style="width: 150px;" class="blogbanner" src="<?php echo base_url() . "uploads/templates/" . $row['image'] ?>" alt="banner">
                                                </td>

                                                <td class="blogTitle"><?php echo strlen($row['title']) > 50 ? substr($row['title'], 0, 50) . '...' : $row['title'] ?></td>
                                                <td class="blogDescription">content...</td>
                                                <td class="blogKeyword"><?php echo $row['theme_url'] ?></td>
                                                <td class=""><?php echo date('d/m/Y', strtotime($row['created_at'])) ?></td>

                                                <td>
                                                    <div class="d-flex">
                                                        <a href="<?php echo base_url() ?>admin/templates/edit/<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 blogeditbtn"><i class="fa fa-pencil"></i></a>
                                                        <a href="javascript:void(0)" data-toggle="modal" data-target="#deleteOrderModalside" data-id="<?php echo $row['id'] ?>" class="btn btn-danger shadow btn-xs sharp rowdeletebtn"><i class="fa fa-trash"></i></a>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php
