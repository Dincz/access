    ...
    <div class="container-fluid">
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/service/create" enctype="multipart/form-data">
                            <div class="form-group">
                                <label class="text-black font-w500">Upload Image (1536×1024px)</label>
                                ...
                                <div class="form-group col-12">
                                    <label>Heading*</label>
                                    <input name="service_heading" type="text" class="form-control" placeholder="Enter Title" required>
                                </div>
                                <div class="form-group col-12">
        ...
        <div class="modal fade" id="editOrderModalside">
            <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="<?php echo base_url() ?>admin/service/edit" enctype="multipart/form-data">
                            ...
                            <div class="form-group col-12">
                                ...
                                <input name="keyword" type="text" class="form-control editModalKeyword" placeholder="trending, new service, Study">
                            </div>
                            <div class="form-group col-12">
                                <div class="form-group">
                                    <label>Category</label>
        ...
        <div class="modal fade" id="deleteOrderModalside">
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form method="POST" action="<?php echo base_url() ?>admin/service/delete" enctype="multipart/form-data">
                        <div class="modal-body">
        ...
        <div class="row">
            ...
            <div class="col-12 mb-3">
                <a href="javascript:void(0)" class="btn btn-primary w-100 m-0" data-toggle="modal" data-target="#addOrderModalside">+ New Service</a>
            </div>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                            <tr role="row" class="odd">
                                                <td><?php echo $i; ?></td>
                                                <td>
                                                    <img style="width: 150px;" class="blogbanner" src="<?php echo base_url() . "uploads/service/" . $row['service-image'] ?>" alt="banner">
                                                </td>

                                                <td class="blogTitle"><?php echo strlen($row['service-heading']) > 50 ? substr($row['service-heading'], 0, 50) . '...' : $row['service-heading'] ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex">
                                                        <a href="<?php echo base_url() ?>admin/service/edit/<?php echo $row['id'] ?>" class="btn btn-primary shadow btn-xs sharp mr-1 blogeditbtn"><i class="fa fa-pencil"></i></a>
