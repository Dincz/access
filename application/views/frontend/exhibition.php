                ...
                <div class="row align-items-center justify-content-center">
                    <div class="col-xl-12">
                        <div class="slider_text text-center">
                           ...
                           <a href="NewCrezvaticCompanyProfile2023.pdf" target="_blank" download="download"><p class="wow fadeInLeft" data-wow-duration="1s" data-wow-delay=".5s"><input type="button" class="down_bn" name="" id="" value="Download Profile"> </p></a>
                        </div>
                    </div>
                </div>
            </div>
