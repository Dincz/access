...
<div id="blogSection">
    <div class="hero_section d-flex align-items-center justify-content-center mb-5">
        <h1 class="scrollTrigger p-3 text-center">Services</h1>
    </div>
        ...
        <div class="body d-flex flex-wrap align-items-start jusitfy-content-center p-3">
            ...
            ?>
                <div class="scrollTrigger box col-12 col-sm-12 col-md-6 col-lg-4">
                    <a class="d-flex flex-column p-3" href="<?php echo base_url() ?>service/<?php echo $row['seo-url']; ?>">
                        <div class="thumnail">
                            <img src="<?php echo base_url() ?>uploads/service/<?php echo $row['service-image']; ?>" class="lazy" data-src="<?php echo base_url() ?>uploads/service/<?php echo $row['service-image']; ?>" alt="<?php echo $row['alt-name']; ?>">
                        </div>
                        <div class="content">
                            <h2 lang="en"><?php echo $row['service-heading']; ?></h2>
